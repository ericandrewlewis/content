...
function focus_comment( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="comment-body">
			<?php _e( 'Pingback:', 'focus' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( 'Edit', 'focus' ), '<span class="edit-link">', '</span>' ); ?>
		</div>
				...
				<div class="comment-metadata">
					<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
						<time datetime="<?php comment_time( 'c' ); ?>">
							<?php printf( _x( '%1$s at %2$s', '1: date, 2: time', 'focus' ), get_comment_date(), get_comment_time() ); ?>
						</time>
					</a>
					<?php edit_comment_link( __( 'Edit', 'focus' ), '<span class="edit-link">', '</span>' ); ?>
...
if ( ! function_exists( 'focus_the_attached_image' ) ) :
/**
 * Prints the attached image with a link to the next attached image.
 */
function focus_the_attached_image() {
	$post                = get_post();
	$attachment_size     = apply_filters( 'focus_attachment_size', array( 1200, 1200 ) );
...
function focus_posted_on() {
	...
	printf( __( '<span class="posted-on">%1$s</span>', 'focus' ),
...
function focus_byline() {
	printf( __( '<span class="byline">by %1$s</span>', 'focus' ),
